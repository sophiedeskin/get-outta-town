...
export default function AddTrip() {
  ...
  const handleChange = (event) => {
    ...
    if (name === 'tripDesc' && value.length <= 280) {
...
<div class="flex h-screen justify-center pt-6  ">
  <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
    ...
    <div class="grid grid-cols-1 mt-5 mx-7">
      <label 
      class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Trip Description</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
      <div class="grid grid-cols-1">
        <label 
        class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Country</label>
